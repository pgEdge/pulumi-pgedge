...
namespace Pgedge.Pgedge
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pgEdge/pulumi-pgedge";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pgedge.Pgedge.version.txt");
    ...
    internal sealed class PgedgeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PgedgeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
