...
namespace Pgedge.Pgedge.Inputs
{
    ...
    public sealed class ClusterNodeGroupsGoogleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.ClusterNodeGroupsGoogleNodeGetArgs>? _nodes;
        public InputList<Inputs.ClusterNodeGroupsGoogleNodeGetArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.ClusterNodeGroupsGoogleNodeGetArgs>());
            set => _nodes = value;
        }
        ...
        public ClusterNodeGroupsGoogleGetArgs()
        {
        }
        public static new ClusterNodeGroupsGoogleGetArgs Empty => new ClusterNodeGroupsGoogleGetArgs();
    }
}
