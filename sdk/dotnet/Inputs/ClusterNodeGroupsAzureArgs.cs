...
namespace Pgedge.Pgedge.Inputs
{
    ...
    public sealed class ClusterNodeGroupsAzureArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.ClusterNodeGroupsAzureNodeArgs>? _nodes;
        public InputList<Inputs.ClusterNodeGroupsAzureNodeArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.ClusterNodeGroupsAzureNodeArgs>());
            set => _nodes = value;
        }
        ...
        public ClusterNodeGroupsAzureArgs()
        {
        }
        public static new ClusterNodeGroupsAzureArgs Empty => new ClusterNodeGroupsAzureArgs();
    }
}
