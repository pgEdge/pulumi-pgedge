...
namespace Pgedge.Pgedge.Inputs
{
    ...
    public sealed class ClusterNodeGroupsAzureGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.ClusterNodeGroupsAzureNodeGetArgs>? _nodes;
        public InputList<Inputs.ClusterNodeGroupsAzureNodeGetArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.ClusterNodeGroupsAzureNodeGetArgs>());
            set => _nodes = value;
        }
        ...
        public ClusterNodeGroupsAzureGetArgs()
        {
        }
        public static new ClusterNodeGroupsAzureGetArgs Empty => new ClusterNodeGroupsAzureGetArgs();
    }
}
