...
namespace Pgedge.Pgedge.Inputs
{
    ...
    public sealed class ClusterNodeGroupsAwArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.ClusterNodeGroupsAwNodeArgs>? _nodes;
        public InputList<Inputs.ClusterNodeGroupsAwNodeArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.ClusterNodeGroupsAwNodeArgs>());
            set => _nodes = value;
        }
        ...
        public ClusterNodeGroupsAwArgs()
        {
        }
        public static new ClusterNodeGroupsAwArgs Empty => new ClusterNodeGroupsAwArgs();
    }
}
