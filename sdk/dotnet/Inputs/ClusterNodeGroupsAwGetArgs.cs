...
namespace Pgedge.Pgedge.Inputs
{
    ...
    public sealed class ClusterNodeGroupsAwGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.ClusterNodeGroupsAwNodeGetArgs>? _nodes;
        public InputList<Inputs.ClusterNodeGroupsAwNodeGetArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.ClusterNodeGroupsAwNodeGetArgs>());
            set => _nodes = value;
        }
        ...
        public ClusterNodeGroupsAwGetArgs()
        {
        }
        public static new ClusterNodeGroupsAwGetArgs Empty => new ClusterNodeGroupsAwGetArgs();
    }
}
