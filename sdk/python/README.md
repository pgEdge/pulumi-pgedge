...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `pgedge` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-pgedge_darwin_amd64_v1
│   └── pulumi-resource-pgedge
├── pulumi-pgedge_darwin_arm64
│   └── pulumi-resource-pgedge
├── pulumi-pgedge_linux_amd64_v1
│   └── pulumi-resource-pgedge
├── pulumi-pgedge_linux_arm64
│   └── pulumi-resource-pgedge
├── pulumi-pgedge_windows_amd64_v1
│   └── pulumi-resource-pgedge.exe
└── pulumi-pgedge_windows_arm64
    └── pulumi-resource-pgedge.exe
```
